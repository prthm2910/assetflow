...
def _build_audit_kwargs(instance, action, old_data=None, new_data=None):
    ...
    if hasattr(instance, "organization_id") and instance.organization_id is not None:
...
def audit_post_save(sender, instance, created, **kwargs):
    ...
    if not hasattr(instance, "organization_id") or instance.organization_id is None:
        return
